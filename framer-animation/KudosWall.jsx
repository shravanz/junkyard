...
export default function KudosWall() {
  ...
  const itemsPerPage = 6; // Show only 6 kudos per page
  ...
  return (
    <div className="kudos-wall">
      <div className="kudos-container">
        ...
        {/* Kudos Grid with Animation */}
        <motion.div
          key={currentPage} // Helps with smooth transitions when changing pages
          className="kudos-grid animated-kudos-grid"
